...
add wave -noupdate -format Analog-Step -height 50 -max 3.0 -min -4.0 -radix decimal /func_gen_tb/func_gen_sine_out
add wave -noupdate -format Analog-Step -height 50 -max 32767.0 -min -32767.0 -radix decimal /func_gen_tb/uut/func_gen_int_sine_data
add wave -noupdate -format Analog-Step -height 50 -max 4095.0 -radix decimal /func_gen_tb/func_gen_pulse_out
add wave -noupdate -format Analog-Step -height 50 -max 31.0 -min -31.0 -radix decimal /func_gen_tb/func_gen_triangle_out
add wave -noupdate -format Analog-Step -height 50 -max 62.0 -radix decimal /func_gen_tb/func_gen_sawtooth_out
...
WaveRestoreCursors {{Cursor 1} {5717822 ps} 0}
